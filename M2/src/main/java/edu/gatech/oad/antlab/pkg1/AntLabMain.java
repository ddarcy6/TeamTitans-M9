 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Reed Rosser");
		  toPrint += p1.toString("arosser6");
		  ...
		  Person3 p3 = new Person3("Prerak Upadhyaya");
		  toPrint += p3.toString("pupadhyaya6");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Fardad Hajirostami");
          toPrint += p4.toString("fhajirostami3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Declan D'Arcy");
          toPrint += p5.toString("ddarcy6");
