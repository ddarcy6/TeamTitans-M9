...
public class WelcomeScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerWarning = (TextView) findViewById(R.id.welcomeWarning);

        Button clickLogin = (Button) findViewById(R.id.WelcomeLoginButton);
        ...
        Button clickRegister = (Button) findViewById(R.id.registerButton);
